...
🟡 3 ĐẶC TÍNH DEFINING FEELING:
  ...
  ③ OBSERVABLE (PFC Có Thể Tương Tác)
     Feeling PHẢI đủ mạnh để PFC access.
     Body tính toán 24/7 — hầu hết KHÔNG trở thành feeling.
     Chỉ khi: signal đủ mạnh / attention hướng vào / change đủ lớn
     → Mới nổi lên thành feeling.
     Có thể từ "cảm thấy sao sao ấy" (vague) đến "đau nhức rõ ràng" (clear).
```
