...
⭐⭐⭐ IMAGINE-FINAL:
  ...
  🟢 Homeostatic drives subcortical: Zimmerman et al. 2016, Eiselt & Bhatt 2021
...
⭐⭐ PHÂN BIỆT 3 TẦNG mà ngôn ngữ thường TRỘN LẪN:
  ...
  🟡 3-Layer + bypass model = framework synthesis
```
...
⭐⭐ NÃO CÓ HỆ THỐNG PREDICTION SUBCORTICAL, KHÔNG PHẢI IMAGINE-FINAL:
  ...
  🟢 Berridge & Robinson 2016: subcortical wanting
...
### §2.3 — MOST PFC-ACCESSIBLE application
...
### §4.1 — Hold + Suppress applied to Imagine-Final
...
═══════════════════════════════════════
  ...
  v3.0 — Homeostatic drives subcortical:      Zimmerman et al. 2016 (Nature)
  v3.0 — mPFC not needed for eating/drinking: Eiselt & Bhatt 2021 (Nat Comm)
  v3.0 — Subcortical wanting:                 Berridge & Robinson 2016
  v3.0 — Anticipatory thirst:                 Gizowski & Bourque 2017
  v3.0 — PFC cascade model:                   Koechlin et al. 2003 (Science)
  v3.0 — Hierarchical frontal control:        Badre & Nee 2018
  v3.0 — Model-based vs model-free:           Daw, Niv & Dayan 2005
  v3.0 — Goals → habits:                      Dolan & Dayan 2013 (Neuron)
...
|---|----------|---------|----------|
| R1 | Schacter & Addis 2007 — Constructive Episodic Simulation (Nature Rev Neuroscience) | §0, §1, §2 | 🟢 |
...
| R4 | Damasio 1994 — Somatic Marker Hypothesis | §0, §4 | 🟢 |
| R5 | Locke & Latham 1990 — Goal-setting theory | §0, §6 | 🟢 |
| R6 | Deci & Ryan 2000 — Self-Determination Theory | §0, §6 | 🟢 |
| R7 | Buckner & Carroll 2007 — Self-projection and the brain | §2 | 🟢 |
| R8 | Buckner, Andrews-Hanna & Schacter 2008 — DMN anatomy (Annals NYAS) | §2, §5 | 🟢 |
| R9 | Bird & Silani et al. 2010 — Anterior insula shared readout (Brain) | §2 | 🟢 |
| R10 | Bird & Cook 2013 — Alexithymia hypothesis | §2 | 🟢 |
| R11 | Fukushima et al. 2011 — Interoceptive accuracy → empathic accuracy | §2, §10 | 🟢 |
| R12 | Mitchell, Macrae & Banaji 2006 — vMPFC/dMPFC dissociation (Neuron) | §2, §10 | 🟢 |
| R13 | Denny et al. 2012 — mPFC spatial gradient (meta-analysis) | §2 | 🟢 |
| R14 | Hassabis et al. 2007 — Hippocampal amnesia → cannot imagine (PNAS) | §1, §2 | 🟢 |
| R15 | Lombardo et al. 2010 — Shared self/other mentalizing (J Cog Neurosci) | §2 | 🟢 |
| R16 | Lopes, Salovey & Straus 2003 — Regulation ↔ interaction (Emotion) | §2, §10 | 🟢 |
| R17 | Coan & Sbarra 2015 — Social Baseline Theory | §2, §10 | 🟢 |
| R18 | Clark 2013 — Predictive Processing | §3 | 🟢 |
| R19 | Friston 2010 — Free Energy Principle | §3 | 🟢 |
| R20 | Cowan 2001 — Working memory capacity | §3, §5 | 🟢 |
| R21 | Miller & Cohen 2001 — PFC top-down attention | §3, §4 | 🟢 |
| R22 | Anderson & Green 2001 — Think/No-Think paradigm | §4 | 🟢 |
| R23 | Wegner 1987 — Ironic process theory | §4 | 🟢 |
| R24 | Berridge 2003 — Wanting ≠ Liking distinction | §4 | 🟢 |
| R25 | Walker 2017 — Why We Sleep (REM consolidation) | §5 | 🟢 |
| R26 | Raichle 2001 — Default Mode Network discovery | §5 | 🟢 |
| R27 | Jeannerod 1995 — Mental simulation = motor pathways | §6 | 🟢 |
| R28 | Kosslyn 1994 — Image and Brain (visual simulation) | §6 | 🟢 |
| R29 | Bandura 1997 — Self-efficacy: spiral model | §6 | 🟢 |
| R30 | Ericsson 1993 — Deliberate practice | §6, §10 | 🟢 |
| R31 | Latham & Pinder 2005 — Work motivation meta-analysis | §6 | 🟢 |
| R32 | Trapnell & Campbell 1999 — Self-reflection vs self-rumination | §9 | 🟢 |
| R33 | Joireman, Parrott & Hammersla 2002 — Self-absorption paradox | §9 | 🟢 |
| R34 | Sapolsky 2004 — Why Zebras Don't Get Ulcers (cortisol effects) | §3 | 🟢 |
| R35 | Aron & Aron 1986 — Self-expansion model | §8 | 🟢 |
| R36 | Gendlin 1978 — Focusing: felt sense technique | §10 | 🟢 |
| R37 | Zimmerman et al. 2016 — Anticipatory thirst neurons (Nature) | §1 | 🟢 |
| R38 | Eiselt & Bhatt 2021 — mPFC not needed for eating/drinking (Nat Comm) | §0, §1 | 🟢 |
| R39 | Koechlin, Ody & Kouneiher 2003 — PFC cascade model (Science) | §1 | 🟢 |
| R40 | Badre & Nee 2018 — Hierarchical frontal control (Trends Cog Sci) | §1 | 🟢 |
| R41 | Daw, Niv & Dayan 2005 — Model-based vs model-free decisions | §1 | 🟢 |
| R42 | Dolan & Dayan 2013 — Goals and Habits in the Brain (Neuron) | §1 | 🟢 |
| R43 | Berridge & Robinson 2016 — Incentive salience without PFC | §1 | 🟢 |
| R44 | Gizowski & Bourque 2017 — Anticipatory thirst (Nat Rev Nephrology) | §1 | 🟢 |
