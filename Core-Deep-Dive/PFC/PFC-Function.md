...
supersedes: |
  ...
  Old files: insights integrated, framing updated to v7.8 cycle-based.
related: |
...
🟢 ESTABLISHED:
  ...
  WM ~4±1 (Cowan 2001)
  PFC online from birth (5 empirical pillars)
  Reconsolidation window (Nader 2000)
  vmPFC-amygdala connection (Ghashghaei 2007)
  NE α1 disconnect (Arnsten 2009)
...
🔴 NEEDS MORE RESEARCH:
  Exact boundary meta-cognition vs observation
  Whether "24 functions" is complete or needs additions
  Quantitative: when exactly PFC override succeeds vs fails
  How PFC hold biases spreading activation at neural level
...
OLD PFC FILES (backup, insights integrated into 3 new files above):
  Imagination/backup/PFC-Analysis-v1.1.md
  Imagination/backup/PFC-4-Dimensions-v1.md
```
