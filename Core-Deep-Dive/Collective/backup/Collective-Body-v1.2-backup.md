...
version: 1.2
created: 2026-05-08
updated: 2026-05-14 (v1.2: §3.5 Dual-Pull Propagation — human-designed systems inherit brain tension)
status: v1.1 MECHANISM FILE
scope: |
  ...
  v1.1 ADDITIONS (Drill E5 Q-S2-3/4/5):
    ⑧ AI = trust entity loại mới (§8.4) — cross-domain default, no accountability
    ⑨ Collective KHÔNG sleep (§4.2 ⑨) — dynasty stagnation = Boredom Loại 3
    ⑩ Open Questions Q-E2-4/5 RESOLVED, Q-E2-2/3 PARTIALLY
  v1.2 ADDITION:
    ⑪ Dual-Pull Propagation (§3.5) — human-designed systems inherit brain tension
...
position: |
  ...
  Valence-Propagation.md. MECHANISM FILE.
  SAU tạo file này: Body-Base.md §9 Reading Guide → add reference.
dependencies:
  - Body-Base.md v2.0 — Model 3+1, 3 loại compile, L0-L1-L3 substrate
  - Body-Coupling.md v1.0 — §2.5 System Compilation (6 mechanisms, coupling proxy)
  - Valence-Propagation.md v1.3 — §2 Body-Base Extension, §4 propagation mechanisms
  - Connection.md v3.1 — 3 Generative Primitives, §14 collective connection
  ...
  - Drill-Draft/Drill-Compile-Short-Collective.md — §5, §8, §22, §25
...
⭐ SYSTEM COMPILATION = 6 MECHANISMS CHẠY ĐỒNG THỜI (Drill §25B):
  ...
  ⑤ COLLECTIVE EFFERVESCENCE (🟢 Durkheim 1912):
     ...
     → Mass SPM co-firing → Pattern-Resonance at group scale
...
⭐ KHÁC MECHANISM, TƯƠNG ĐƯƠNG INTENSITY, KHÁC QUALITY (Drill §25C):
  ...
  🟡 Religion = strongest system compilation = framework synthesis (Drill §25E)
```
...
⭐ AI = EXTERNAL TOOL CỰC MẠNH CHO CẤP 2 (Drill §22E-F):
  ...
  🟡 Install-compile speed gap = framework synthesis
  🟡 AI bias systemic hijack = extends §5.3
  🟡 Source+speed change, mechanism unchanged = core principle
...
🟢 HIGH CONFIDENCE (Research Support):
  ...
  ✓ Cultural evolution + cumulative culture (Henrich 2016)
  ...
  ✓ Refugee mental health (Fazel 2005)
  ✓ Religious deconversion grief (Streib 2014)
  ✓ Confabulation (Nisbett & Wilson 1977)
  ✓ Social proof (Cialdini 1984)
...
🟡 MEDIUM CONFIDENCE (Framework Synthesis):
  ...
  ⚠ Global-Body analogy ~70%/~30% split
    — each mapping grounded, quantification = approximate
  ⚠ Trust hijack (cross-domain trust transfer)
  ...
  ⚠ 3 proxy types (leader/symbol/virtual agent)
    — each type established, unified taxonomy = novel
  ⚠ Chain break model (cost/link/compound)
    — each type consistent, taxonomy = novel
...
WITHIN BODY-BASE/ FOLDER:
  Body-Base.md v2.0         — Entry point, Model 3+1, 3 Loại compile, L0-L1-L3
  Body-Coupling.md v1.0     — §2.5 System Compilation (6 mechanisms, coupling proxy)
  Valence-Propagation.md    — §2 Body-Base Extension, §4 propagation, §5 chain trust
...
OBSERVATION/ FOLDER:
  Connection.md v3.1        — §14 collective connection, 3 Generative Primitives
  Status.md v2.0            — Resource Access Map (collective status structure)
  Meaning.md v2.0           — §3.3 IDENTITY anchor, §3.4 FAITH anchor
  Empathy.md v2.0           — SPM applied to others (collective empathy)
...
RESEARCH:
  ...
  AI-Schema-Detection.md    — §3 (7 capabilities, collective extension)
...
AGENT-MECHANISM:
  Agent-Mechanism.md        — §12.4 Schema-agent (virtual agent), §12.5 Hardware belonging
  Self-Pattern-Match.md     — F1/F2 (SPM co-firing in collective effervescence)
  Pattern-Resonance.md      — §0.3 collective Pattern-Resonance
...
>
> Key contributions:
>   §1: Model 3 cấp — resolve "cơ chế valence kỳ quái"
>   §2: Cấp 1 — 4 compile pathways, PFC confabulation
>   §3: Cấp 2 — scale hierarchy, Cấp 2 cá nhân (external tools), knowledge engine
>   §4: Global-Body analogy — ~70% mapping + ~30% breaks (no unified PFC)
>       v1.1: ⑨ collective KHÔNG sleep (dynasty = Boredom Loại 3)
>   §5: Trust bridge — hijack (KOL, brand), chain break ("học làm gì"), defense
>   §6: System Compilation — 6 compound mechanisms, L2 vs system, religion = strongest
>   §7: Coupling proxy — leader/symbol/virtual agent
>   §8: AI era — tool cho cả 2 cấp, AI ≠ collective PFC
>       v1.1: §8.4 AI = trust entity loại mới (cross-domain, no accountability,
>       install-compile gap, systemic bias, source+speed change not mechanism)
>
> BB2 = BB1 + collective scale + hardware variance.
> System Compilation ≠ L2: khác mechanism, tương đương intensity, khác quality.
> Trust = ancient mechanism, modern exploit → need collective defense.
>
> Resolves: GAP 12 (CRITICAL) + GAP 9.
> Source: Drill S1-S6 (§5, §8, §22, §25) + Drill E5 (Q-S2-3/4/5). Phase E2+E5.
> Phiên bản: v1.1, 2026-05-08.
