...
**Dependencies**: Drill-SPM-Mechanism-Analysis v2.2 §10 (SPM×IF same engine), Self-Pattern-Modeling v3.0, Imagine-Final.md, Feeling.md (PFC observation), Body-Feedback-Mechanism v2.0 §3
...
| Self-Pattern-Modeling v3.0 | §2 (F1/F2), §8 (calibration) | MECHANISM file for SPM |
