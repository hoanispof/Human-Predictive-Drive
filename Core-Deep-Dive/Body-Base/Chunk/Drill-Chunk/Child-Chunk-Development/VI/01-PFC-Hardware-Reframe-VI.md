...
- DMN đặc biệt thú vị — nó là mạng "nghỉ ngơi", thường liên quan đến các quá trình self-referential và simulation ở người lớn. Sự hiện diện từ 2 tuần phù hợp với substrate sẵn sàng cho self-pattern compilation (liên kết với Agent/Self-Pattern-Modeling §5 developmental bootstrap).
