...
**Vô thức KHÔNG thể**: check domain accuracy, simulate future, compare với memory. Vô thức **chỉ đo body-base** → body sướng → vô thức "OK" → dù domain có thể sai (nghiện, limerence, comfort zone).
...
| **H9** | **Agent = Self-Pattern-Match unified** | **Agent ✅** | **— (standalone N+2 drilled)** |
