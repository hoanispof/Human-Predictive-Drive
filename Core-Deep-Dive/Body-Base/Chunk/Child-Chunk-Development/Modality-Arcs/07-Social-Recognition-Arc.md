...
- Self-Pattern-Match forward mechanism in detail (see [Agent/Self-Pattern-Match.md](../Agent/Self-Pattern-Match.md))
...
**Cross-reference to Agent/**: [Agent/Self-Pattern-Match.md](../Agent/Self-Pattern-Match.md) covers the self-pattern-match mechanism in adult form. 07 E31 shows the **developmental origin** at 18-24 months — first clear observable self-as-agent chunks.
...
[Agent/Agent.md](../Agent/Agent.md) or [Agent/Self-Pattern-Match.md](../Agent/Self-Pattern-Match.md) covers mirror self-recognition emergence (Amsterdam 1972 rouge test). This happens in 18-24 month window (E32 in Feel-Example), crossing into "Mirror self-recognition" milestone. 07 notes this falls at the end of F1 window and is treated as a transition marker to the Agent architecture proper. Full drill in Agent/.
