...
- Ends in peak reward (intensely pleasant)
...
🟡 **H9** (from `Chunk-Analysis/Agent/` drill): Agent-reading uses Self-Pattern-Modeling (solo forward mechanism) + Resonance (emergent mutual phenomenon). Integrates social cognition.
