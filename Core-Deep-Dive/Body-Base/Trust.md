...
⭐⭐ DEFINITION:
  ...
  Formal:
    trust(entity) = compiled_aggregate(
      history of entity's gap-fill outcomes,
      weighted by recency + salience + consistency
...
⭐⭐ 3 SUB-DIMENSIONS OF TRUST:
  ...
  MAPPING TO RESEARCH:
    ...
    ① Authority ≈ Power/Position (not in Mayer model — framework ADDS this)
...
🟡 Trust = compiled prediction about reliability = NEW framing (framework synthesis)
...
🟢 Cultural transmission: Rachman 1977
```
...
🟢 Identity-based trust: Brewer & Gardner 1996
```
...
🟡 Collective-Body §5.1 reconciliation = framework enrichment (not contradiction)
🟢 Trust development: Rotenberg 2010
🟢 Trust calibration: Lewicki et al. 2006
🟢 Epistemic trust: Csibra & Gergely 2009
```
...
⭐⭐ 6 MECHANISMS ACROSS 3 LAYERS — EXPLAINS WHY POSITIVE TRUST + POSITIVE VALENCE
  ...
  ⭐ SUMMARY:
    ...
    │              │                         │ → both trust + valence ↑   │
    ├──────────────┼─────────────────────────┼────────────────────────────┤
    │ ② Hardware   │ Learning drive          │ Approach competent entity  │
    │              │                         │ → compilation benefit      │
    ├──────────────┼─────────────────────────┼────────────────────────────┤
    │ ③ Evaluative │ Smoothing / Halo        │ Positive coupling →        │
    │              │                         │ smooth negatives → loop    │
    ├──────────────┼─────────────────────────┼────────────────────────────┤
    │ ④ Evaluative │ Coherence drive         │ Must trust + valence neg   │
...
🟢 Betrayal trauma: Freyd 1996
🟢 Threshold model: Granovetter 1978
```
...
🟢 Prestige bias: Henrich & Gil-White 2001
...
🟡 Connection to Coordination-Node trust cascade = framework extension
🟢 Institutional vs interpersonal trust: Lewicki et al. 2006
```
...
🟡 5 cases = framework synthesis applying trust × valence × gap-fill model
🟢 Anxious attachment: Hazan & Shaver 1987
🟢 Big Gods: Norenzayan 2013
```
...
🟢 HIGH CONFIDENCE (Research Support):
  ...
  ✓ Negativity bias: Baumeister et al. 2001
  ✓ Trust asymmetry: Slovic 1993
  ✓ Trust development in children: Rotenberg 2010
  ✓ Adult attachment: Hazan & Shaver 1987
  ✓ Social learning: Bandura 1977
  ✓ Big Gods: Norenzayan 2013
  ✓ Mortality salience: Jonas & Fischer 2006
  ✓ Trust development + violations: Lewicki et al. 2006
