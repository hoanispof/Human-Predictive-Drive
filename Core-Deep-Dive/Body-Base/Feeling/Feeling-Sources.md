...
🟡 FEELINGS CÓ NHIỀU NGUỒN — KHÔNG PHẢI 1:
  ...
  │  ⑧ IMAGINE-FINAL          → preview/anticipation feelings   │
...
🟢 L0 — THREAT CHANNEL:
  ...
  Feeling characteristics:
    → FAST (milliseconds)
    → LOCATION UNKNOWN (PFC struggles to identify body source)
    → HIGH STRENGTH (body treats as priority)
    → HARD TO VERBALIZE (often no clear "why")
    → OVERRIDES other feelings when active
...
🟢 L1 — PHYSIOLOGICAL / INTEROCEPTIVE CHANNEL:
  ...
  Mechanism:
    → Interoception afferent pathways (Craig 2002, 2013) 🟢
    → Insula as integration hub
    → Vagal afferents + spinal afferents
    → Homeostatic monitoring of organ states
  ...
  Research:
    ...
    🟢 Craig 2013 follow-up synthesis
    🟢 Sherrington proprioception (classic)
    🟢 Pain research — nociception + processing
```
...
🟢 L2 — EXPERIENCE / NOVELTY CHANNEL:
  ...
  Mechanism:
    → VTA dopaminergic system (SEEKING, Panksepp) 🟢
    → Novelty detection circuits
    → Habituation (adaptation curve)
  ...
  Research:
    🟢 Panksepp SEEKING system (1998, 2012)
    🟢 Schultz reward prediction error (1997)
    🟢 Berridge wanting vs liking distinction (2009)
```
...
🟢 L3 — MASTERY / MEANING / STATUS CHANNEL:
  ...
  Mechanism:
    ...
    → Self-schema firing (compiled self-models)
    → Social comparison circuits
    → Long-timescale reward encoding
...
🟢 AGENT INPUT — A BODY-BASE NEED (independent channel):
  ...
  Research support:
    ...
    🟢 Bucharest Early Intervention — agent deprivation damages development
    🟢 Solitary confinement research — extreme deprivation = severe harm
  ...
  Research:
    ...
    🟢 Holt-Lunstad 2015 — loneliness mortality meta-analysis
```
...
🟢 MIRROR — FEELINGS ABOUT OTHERS' STATES:
  ...
  Purpose:
    ...
    → Social learning
    → Emotional contagion (intentional or not)
  ...
  Research:
    ...
    🟢 Rizzolatti 1996 mirror neurons
    🟢 Ambady 1993 thin slices
    🟢 Hatfield 1994 emotional contagion
    🟢 Singer 2004 pain empathy circuits
    🟡 Heyes ASL theory (2010+) alternative framework
```
...
🟢 SCHEMA — FEELINGS FROM COMPILED KNOWLEDGE:
  ...
  Mechanism:
    → Compiled knowledge fires when pattern matches
    → Schema stores emotional weight (not just facts)
    → Memory reactivation includes somatic marker (Damasio)
    → Long-term potentiation + reconsolidation

  Purpose:
    → Fast response to familiar situations
    → Don't recompute from scratch
    → Emotional regulation based on history
    → Rapid meaning assignment
  ...
  Research:
    🟢 Damasio somatic marker — emotional memory
    🟢 LTP / LTD long-term potentiation
    🟢 Reconsolidation research (Nader 2000)
    🟢 PTSD research — trauma schema mechanism
    🟢 Placebo/nocebo research — schema effect on body
```
...
🟢 IMAGINE-FINAL — FEELINGS FROM FUTURE PREVIEW:
  ...
  Research:
    ...
    🟢 Kahneman 2011 System 1 = fast preview-based
    🟢 Gilbert 2007 "Stumbling on Happiness" (affective forecasting)
```
...
🟢 VALENCE — FEELINGS FROM COMPILED ASSESSMENTS:
  ...
  Feeling characteristics:
    → Entity-specific
    → Stable over time (slow to update)
    → Single-word label usually
  ...
  Research:
    ...
    🟢 Ventral striatum compiled reward
    🟢 Somatic marker — Damasio
    🟢 Attitude research (Fiske, Cuddy et al.)
```
...
🟢 COGNITIVE / PREDICTION — FEELINGS FROM THINKING:
  ...
  Feeling characteristics:
    ...
    → Fast for experts, slow/absent for novices
    → Often pre-verbal
  ...
  EXPERTISE = COMPILED COGNITIVE FEELINGS:
    10,000 hours → pattern library compiled
    → Expert feels correct/incorrect instantly
    → Novice must reason step-by-step
    → Expert intuition = compiled cognitive feelings

  Research:
    🟢 Klein 1998 naturalistic decision making
    🟢 Chase & Simon chess expertise (1973)
    🟢 Kounios 2014 insight neural signature
  ...
  Research:
    🟢 Kounios 2014 aha moment
    🟢 Klein 1998 naturalistic decision
    🟢 Chase & Simon 1973 chess experts
...
⭐ CASE STUDY — WHY SINGLE WORD CAPTURES MULTI-CHANNEL STATE:
  ...
  ── L1 PHYSIOLOGICAL CHANNEL ──
     ...
     → HR slows, BP normalizes
     → Cortisol low
     → "Mild arousal" if romantic (HPA + sexual)
     → Comfort touch: oxytocin release
     → Co-regulation of physiological rhythms (Coan 2015)
  ...
  TOTAL: 9+ channels firing simultaneously.
  ...
  UNIVERSAL FRAMEWORK PRINCIPLE:
    → Strong feelings = usually multi-channel
    → Single label = PFC compression
    → Decomposition helps literacy
    → Acceptance of compression limits is wise
...
📚 MAINSTREAM RESEARCH KEY REFERENCES:
  ...
  L0 Threat:
    LeDoux 1996, Amygdala research
    Ambady 1993 thin slices
    de Becker 1997 (practical)

  L1 Interoception:
    Craig 2002, 2013
    Insula integration research
  ...
  Imagine-Final:
    Damasio 1994 somatic marker
    Klein 1998 naturalistic decision
    Gilbert 2007 affective forecasting

  Valence:
    Classical + operant conditioning
    Ventral striatum compilation

  Cognitive:
    Klein 1998
    Chase & Simon 1973
    Kounios 2014 insight
```
