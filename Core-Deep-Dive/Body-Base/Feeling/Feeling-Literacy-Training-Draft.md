...
⭐ STAGE 3 — PATTERN RECOGNITION:
  ...
  EXPECTED OUTCOMES:
    → After ~6-12 months:
      → "Vague" feelings now have recognizable PATTERNS
...
### §4.3 — Somatic-Articulation-Loop connection: Focusing = Somatic-Articulation-Loop applied to feeling
...
🟡 FOCUSING = Somatic-Articulation-Loop APPLIED TO FEELING SPECIFICALLY:
  ...
  ⭐ 3 Somatic-Articulation-Loop CATALYSTS × FEELING TRAINING:

    Somatic-Articulation-Loop Catalyst Type 1 — Human partner (Focusing partner, therapist):
      → Partner suggests handles → body vote → refine
      → BEST for: deep emotional patterns, trauma-adjacent content
      → = Therapy modalities (EFT, Hakomi, Simulation-Engine) all use this

    Somatic-Articulation-Loop Catalyst Type 2 — Self (solo Focusing):
