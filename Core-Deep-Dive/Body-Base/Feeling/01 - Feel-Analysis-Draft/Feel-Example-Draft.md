...
**Status**: ✅ **PHASE 2 COMPLETE** (2026-04-14) + **§9b REFINEMENT**
added same day. **124 examples** filled total.
**Purpose**: Extensive collection of real examples showing PFC feeling
capability development — foundation for synthesis files.
**Memory ref**: `project_pattern_match_insights.md`
**Created**: 2026-04-14
**Phase 2 completed**: 2026-04-14
**§9b refinement added**: 2026-04-14 (same day, user meta-question)
...
**Scenario**: [Concrete situation, 1-3 sentences]

**Verbalization** (if any): "..."

**Channel(s)**: [Which channels active]
...
**Scaffolding required**: [What must be learned/experienced first]

**Prevalence**: [~% of population reaching this — rough estimate]

**Notes**: [Any nuances, variations, research refs]
```
...
Pattern Match thực sự nếu định nghĩa SPM = PFC observe được state có
...
đây là entry point thực sự cho SPM verbalized.
...
- Integration: multi-channel
- Action coupling: simulator-based (action driven by simulated
  identity)
...
**Chunk(s)**:
- Pride chunk: (self-achievement + social validation) → positive
...
**Axis position**:
- Depth: deeper (self chunks)
- Breadth: multi-channel
- Speed: arises gradually after achievement
- Integration: multi-channel
...
- Breadth: multi-channel
- Speed: rapid onset
- Integration: multi-channel + recursive (self-perceiving-others-
  perceiving-self)
...
6. **Compound emotion chunks** (E42 jealousy, E43 pride, E44
   embarrassment)
   - Form: combine multiple chunks (primary emotion + cognitive
     operation + social context) → emergent complex emotion
   - Status: first compound chunks
   - Nature: combinatorial explosion mechanism — allows feeling
     vocabulary to grow exponentially

7. **Self-conscious emotion chunks** (E43 pride, E44 embarrassment)
...
- Breadth: multi-channel
- Speed: arises after achievement recognition
- Integration: multi-channel + temporal + social
...
**Axis position**:
- Depth: deeper than E44 (lasting + identity-affecting)
- Breadth: multi-channel
- Speed: rapid onset, sustained aftermath
...
|---|---|
| Situation-specific | Identity-affecting |
| Momentary | Lasting (days to years) |
| "I did something silly" | "I AM defective" |
...
- Action coupling: tight (protest, complaint)

**Scaffolding required**: Discussion of fairness, exposure to varied
principles (equal distribution vs need-based vs merit-based vs
procedural).
...
- Depth: deep
- Breadth: multi-channel
- Speed: builds over seconds to minutes
...
- Integration: multi-channel
- Action coupling: tight (joy → celebration with other)

**Scaffolding required**: Family modeling celebration of others,
secure attachment (no scarcity mindset), emphasis on collaboration
over competition.
...
- Capability assessment chunk: "this matches problems I've solved
  before"
- Confidence chunk: predictive certainty without proof yet

**Stage**: Self-Pattern Match Stage 5+ (metacognitive layer).
...
**Axis position**:
- Depth: metacognitive new
- Breadth: multi-channel
- Speed: immediate hesitation
- Integration: multi-channel
...
1. **Over-confidence** (E54 strong, E55 weak): Dunning-Kruger
   pattern, doesn't know they don't know
...
**Chunk(s)**:
- Fatigue chunk — mature form, multi-component
- Body awareness chunk linking signal to action need
- Self-care chunk: "I should rest"

**Stage**: Self-Pattern Match Stage 5; body chunks mature.

**Axis position**:
- Depth: depth in body (multi-component fatigue)
- Breadth: multi-channel body
- Speed: gradual recognition
...
**Axis position**:
- Depth: depth in body + predictive
- Breadth: multi-channel body
...
**Chunk(s)**:
- **Anticipation chunk** — positive valence form
- Future-oriented feeling chunk
- Compound: imagination + memory + positive valence

**Stage**: Self-Pattern Match Stage 5+; future-oriented chunks
mature.

**Axis position**:
- Depth: depth in temporal dimension
- Breadth: multi-channel
- Speed: builds over days
...
- §3 (toddler): basic future awareness emerging (separation distress
  E17)
- §4 (early childhood): pretend with future scenarios (E38)
- §5 (middle childhood): rich future emotional life (E59)
...
**Axis position**:
- Depth: depth (compound + temporal)
- Breadth: multi-channel
- Speed: rapid initial reaction, sustained aftermath
- Integration: multi-channel + temporal
...
**Axis position**:
- Depth: deep social
- Breadth: multi-channel reading + behavioral adjustment
- Speed: rapid recognition (seconds)
- Integration: multi-channel
...
5. **Social pain chunks** (E53)
   ...
   - Status: shares neural substrate with physical pain
...
7. **Mature body chunks with prediction** (E56 fatigue, E57 sickness)
   - Form: body signal patterns → mature labeling + predictive +
     action need
   - Status: full Self-Pattern Match for body channel
   - Nature: vulnerable to suppression by push culture
...
10. **Sophisticated Resonance** (E61 mood reading)
    ...
    - Nature: can develop healthily or distortedly (parentification)
...
- Breadth: multi-channel + abstract + social
- Speed: sustained, often lasting weeks/months
- Integration: multi-channel + recursive + temporal
...
**Axis position**:
- Depth: very deep (meta-level self chunks)
- Breadth: integrates all channels
...
**Axis position**:
- Depth: deep (multi-component, novel)
- Breadth: multi-channel + hormonal + imagination
- Speed: intense, often surprising onset
- Integration: maximum
...
- Breadth: maximum
- Speed: intense, sustained for weeks/months
- Integration: maximum
...
**Axis position**:
- Depth: increasingly deep with chronic exposure
- Breadth: multi-channel + social media specific
- Speed: triggered instantly by social media
- Integration: visual + social + cognitive + emotional
...
**Chunk(s)**:
- **Future anxiety chunk** = (multiple possible futures) + (no
  clear best) + (high stakes) + (uncertainty intolerance)
- Decision paralysis chunk
...
- Integration: cognitive + emotional + identity + temporal
- Action coupling: paralysis or impulsive decisions
...
**Axis position**:
- Depth: deep (moral + values + identity)
- Breadth: multi-channel + abstract
- Speed: intense, can be sustained
...
expression → potential for distortion in echo chambers.
...
**Axis position**:
- Depth: very deep (integrative)
- Breadth: maximum
- Speed: can be sudden ("aha"), can build gradually
- Integration: maximum (chunks aligned)
- Action coupling: tight (purpose drives action)
...
- Capability self-assessment (E54)
- Values chunks (E50, E71)
- Future chunks (E59, E70)
- Identity chunks (E64)
- All in alignment
...
- Breadth: multi-channel + abstract
- Speed: arises in moments
- Integration: cognitive + emotional + values
...
- Breadth: multi-channel
- Speed: builds over minutes to hours
- Integration: multi-channel + conflicting
...
**Axis position**:
- Depth: deep (temporal + identity)
- Breadth: multi-channel
- Speed: builds and lingers
...
+ self chunks (temporarily quieted).

**Chunk(s)**:
- **Awe chunk** = (vast stimulus) + (cognitive accommodation needed)
  + (temporary self-dissolution) + (positive valence)
- Self-transcendent emotion
- Distinctive body response (chills, "shivers")

**Stage**: Self-Pattern Match Stage 6+; self-transcendent emotions
emerging.

**Axis position**:
- Depth: deep (touches all levels)
- Breadth: multi-channel + transcendent
- Speed: sudden onset
- Integration: maximum
...
5. **Modern technology-amplified chunks** (E68 FOMO)
   - Form: existing chunks (exclusion, envy) chronically activated
     by design choices
   - Status: hijacking of normal chunks by technology
   - Nature: modern problem requires modern hygiene
...
problems' patterns activated subconsciously) + predictive signal.
...
- Predictive signal: "this argument has features of winning
  arguments"
- Chunk based on professional expertise
...
sickness patterns) + predictive signal + verbal.

**Chunk(s)**:
- **Predictive sickness chunk** — multi-component pattern
...
- Depth: deep body
- Breadth: multi-channel body
- Speed: gradual recognition over hours
- Integration: multi-channel + memory + prediction
...
**Chunk(s)**:
- **Outcome prediction chunk** — most sophisticated type
- Pattern matching: project features vs remembered outcomes
- Multiple sub-channels: technical risk + team dynamics + market
...
**Axis position**:
- Depth: deep body + meta
- Breadth: multi-channel body
- Speed: clear inflection point
- Integration: multi-channel
- Action coupling: tight
...
**Axis position**:
- Depth: deep metacognitive
- Breadth: cognitive + meta
- Speed: instant recognition
- Integration: memory + meta + body
- Action coupling: search behavior
...
predictive (anticipated consequences).

**Chunk(s)**:
- **Stress-from-anticipation chunk** = future event + stakes +
  time pressure → body activation
- Mature anxiety chunk
- Body and cognitive coupling tight

**Stage**: Self-Pattern Match Stage 7.

**Axis position**:
- Depth: multi-channel
- Breadth: body + cognitive + temporal
- Speed: builds over days
- Integration: body + emotion + cognitive + future
- Action coupling: variable (work harder, procrastinate, plan)
...
- Action coupling: tight (move selection)
...
- Breadth: maximum sensory integration
- Speed: fast (seconds)
...
- Integration: memory + meta
- Action coupling: communication
...
| E84 Tip of tongue | "I know but can't retrieve now" |
...
Modern formal education often does little metacognitive cultivation
— content focus, less on "how do you know what you know".
...
## §8 Refined Adult / Training (specialized)
...
**Axis position**:
- Depth: very deep
- Breadth: body + cognitive + emotional + meta
- Speed: slow (minutes to develop)
- Integration: maximum
...
**Axis position**:
- Depth: very deep social
- Breadth: maximum reading
- Speed: fast intuitive
- Integration: maximum
...
**Axis position**:
- Depth: very deep aesthetic
- Breadth: visual + cognitive + emotional + meta
...
**Axis position**:
- Depth: maximum auditory
- Breadth: narrow (auditory specifically)
- Speed: instantaneous
...
**Axis position**:
- Depth: maximum kinesthetic
- Breadth: kinesthetic + meta-body
- Speed: real-time during movement
...
**Axis position**:
- Depth: deep linguistic
- Breadth: linguistic + aesthetic + meta
- Speed: fast (immediate when reading)
...
5. **Clinical intuition chunks** (E98)
   - Form: multi-channel patient reading + theoretical knowledge
   - Status: medical training + practice
...
## §9 Existential / Philosophical (highest)
...
**Axis position**:
- Depth: very deep (recurring pattern + values conflict)
...
**Axis position**:
- Depth: deep (self + meta + body)
- Breadth: integrates many chunks
- Speed: arises in calm reflection after dysregulation
- Integration: maximum
- Action coupling: variable
...
**Axis position**:
- Depth: very deep
- Breadth: maximum integration
- Speed: builds over reflection time
...
**Stage**: Self-Pattern Match Stage 7+ (existential peak).
...
**Axis position**:
- Depth: maximum
- Breadth: integrates everything
- Speed: can be sudden (epiphany) or gradual recognition
...
- Often suppressed in daily life (terror management)
- When activated, profoundly affects priorities
- Compound: fear + acceptance + values clarification + urgency
...
**Axis position**:
- Depth: deep self + transcendent
- Breadth: maximum
- Speed: arises in specific contexts (nature, contemplation)
...
- Self chunks temporarily absent
- Sense of oneness with larger reality
- Compound: peace + love + awe + boundary dissolution

**Stage**: Self-Pattern Match Stage 7+ (peak transcendent).

**Axis position**:
- Depth: maximum
- Breadth: all channels altered
- Speed: arises spontaneously or through practice
...
**Stage**: Self-Pattern Match Stage 7+ (transcendent dimension).

**Axis position**:
- Depth: maximum
- Breadth: integrates self + sensory + emotional + meta
- Speed: arises in moments
...
**Axis position**:
- Depth: maximum
- Breadth: extends beyond own life
- Speed: builds over reflection
...
4. **Vocation/calling chunks** (E109)
   - Form: alignment of values + capability + meaning + future
   - Status: rare integration
   - Nature: requires conditions modern life rarely provides

5. **Mortality awareness chunks** (E110)
   - Form: full recognition of own death as real
   - Status: usually suppressed; profound when activated
...
## §9b — Supplementary: Drive & Compulsion Chunks
...
| Group | Examples | Characterization |
|---|---|---|
| **Cognitive pull-forward** | E117, E118, E124 | Mental exploration as drive |
...
|---|---|
| Ease, peaceful alignment | Anxious urgency |
| "This is what I am for" | "I MUST build before time runs out" |
| Sustainable without anxiety | Chronic stress component |
...
- Áo dài tailoring — Hà Nội, Huế, Sài Gòn masters
...
2. **Cognitive psychology research**:
   - Koriat (feeling of knowing, E54, E78)
...
3. **Therapeutic và contemplative traditions**:
   ...
   - James (mystical experiences, E112)
   - Stace (mystical phenomenology, E112)

4. **Cross-cultural anthropology**:
   - Vietnamese-specific emotions (ấm ức E46, ghen tị E47)
   - Asian shame culture comparisons (E49)
   - Tea ceremony traditions (E101)
   - Cross-cultural rouge test (E32)

5. **Common observation**:
   - Universal childhood experiences
   - Common adult dilemmas
...
- Universal adult experiences
- Public historical figures' documented experiences
- Anonymous clinical cases from literature
