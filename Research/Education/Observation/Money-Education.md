...
position: |
  Research/Education/Observation/ — ngang hàng Empathy-Education.md,
  Education-Arms-Race.md. Thuộc BỘ EDUCATION:
  ...
  File này BUILD TRÊN:
    ...
    - Background-Pattern.md v1.0 (2D model Depth×Density, invisible bias)
dependencies:
  primary:
    - Money-Analysis.md v1.0 — 3-layer def, 5 functions, 6 paths, gap shift, L2×tiền
    - Education-Mechanism.md v1.0 — 8 nguyên lý, bridge, 4 nguồn fill, approach/avoidance
  ...
  secondary:
    ...
    - Domain-Knowledge-Map.md v1.0 — §1.2 Numeracy → financial literacy branch
    - Empathy-Education.md v2.0 — parallel Observation file, positive-sum logic
  mechanism:
...
research:
    ...
    - Deci 1971, Lepper et al. 1973 — overjustification effect
    - Kahneman & Deaton 2010 — income ↔ well-being threshold
    - OECD PISA 2022 — financial literacy 15-year-olds, 20 countries
    - Heckman 2006 — early childhood → adult economic productivity
...
⭐ BẢN ĐỒ:
  ...
  QUAN HỆ:
    ...
    = Giống Empathy.md (mechanism) → Empathy-Education.md (application)
  ...
  VỊ TRÍ TRONG BỘ EDUCATION:
    ...
    │   Empathy-Education.md   │ HOW dạy empathy thực tế                  │
...
🟢 RESEARCH FINDING CỐT LÕI:
  ...
  Whitebread & Bingham (2013, UK Money Advice Service):
    ...
    → Executive functions (inhibition, working memory, cognitive flexibility)
      develop in early childhood → drive financial habit formation.
...
⭐ FINDING CỐT LÕI NHẤT TRONG MONEY EDUCATION RESEARCH:
  ...
  🟢 Mandell 2008:
    ...
    had NO measurable impact on financial literacy or financial behavior."

  🟢 Amagir et al. 2018 (systematic review):
    School-based programs improve financial KNOWLEDGE and ATTITUDES
    but studies measuring ACTUAL BEHAVIORAL CHANGE are "scarce
    and show minimal effect."

  🟢 CFPB literature review:
    Experiential learning + parental involvement = strongest predictors.
...
🟡 GIAI ĐOẠN NÀY: PRACTICE QUẢN LÝ TIỀN THẬT:
  ...
  🟢 Age 7: recognize money's purpose, plan expenses (Whitebread 2013)
  🟢 Age 12: economic understanding comparable to adults (Kalish)
...
⚠️ 5 CHUNKS ĐỘC HẠI — NẾU COMPILED → DAMAGE DÀI HẠN:
  ...
  ⑤ [CHO = MẤT / THIỆT]:
    → Zero-sum default (Empathy-Education §1.1)
...
→ Connection.md v3.1 — L2 Bonds
  2-luồng (§3.3), L2 structural (§5).
  Kết nối: §7 (L2 × tiền).
...
→ Domain-Knowledge-Map.md v1.0 — §1.2 Numeracy → financial literacy branch
→ Empathy-Education.md v2.0 — Parallel observation file, positive-sum logic
→ Education-Arms-Race.md — Arms race context
...
→ Expansion-Saturation-Crisis.md v1.1 — Credential inflation, tiền × giáo dục
