...
🟡 MEDIUM CONFIDENCE (Framework Synthesis):
  ...
  ⚠ Body-check = detecting Dissonance Signal (Evaluative vs Direct-State)
    (Dissonance-Signal-Architecture v1.0, application to repetition = novel)
  ⚠ Hardware-Subsidy as transition subsidy (Teacher MODERATE, AI NONE)
