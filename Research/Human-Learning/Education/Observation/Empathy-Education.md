...
### §2.4 — Resonance — connection THẬT emerge

```
🟡 RESONANCE = KHI EMPATHY CẢ 2 PHÍA THÀNH CÔNG:
...
🟡 NGUYÊN TẮC XÉN SUỐT MỌI LỨA TUỔI:
  ...
  ⑤ ĐỦ THỜI GIAN — connection KHÔNG instant:
    → Resonance cần repeated calibration loops
...
```
  ...
  FRAMEWORK SUY LUẬN (🟡):
    ...
    🟡 "Calibration loop" — framework synthesis (By-Product-Gap-Resonance.md)
