...
🟡 CONNECTION.MD V3.1 + BODY-COUPLING.MD V1.1:
  ...
  Social connection provides:
    ...
    → L2 reward (Entity-owned, structural — bạn thân = body-base extension)
...
```
  ...
  COMPILE + RECOVERY:
    → Compile-Taxonomy.md v1.1 — 3 Loại A/B/C, 4 pathways
    → Background-Pattern.md v1.0 — invisible bias, sleep = accelerator
    → Connection.md v3.1 — social coupling, L1/L2 reward
