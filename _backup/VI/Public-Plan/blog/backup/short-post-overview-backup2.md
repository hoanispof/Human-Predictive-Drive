...
status: Draft v0.1
overview_blog_url: https://hoanispof.github.io/Human-Predictive-Drive/blog/bridging-neuroscience-psychology/
...
>
> Structure:
>   ① WHAT → ② POSITION → ③ OVERVIEW → ④ DEEP-DIVES (4 blog links) →
...
**Title:** A concept bridging neuroscience and psychology into a unified architecture — estimating the direction of human drive
...
A framework connecting neuroscience, psychology, and evolutionary biology into a unified architecture — mapping how the brain's core systems produce behavior, 
...
After an exhausting day, you snap at someone despite knowing better. The conscious mind was fully aware — it just couldn't override the body's reaction.  
...
The overview blog proposes mechanistic answers to 11 questions — from why scrolling social media drains while a close friend energizes, to why limerence (the intense early phase of romantic love) is biologically guaranteed to end.  
Six mechanism sketches with research citations. Five seemingly unrelated experiences traced to one architectural fact about the human body. Explicit conditions for being wrong.  
Full overview blog: https://hoanispof.github.io/Human-Predictive-Drive/blog/bridging-neuroscience-psychology/

Four deep-dives on specific positions:
...
EXCEPTION:
  r/MachineLearning → thêm [D] tag đầu title:
    "[D] A concept bridging neuroscience and psychology into a connected model
...
SUBMIT TYPE: Link submission
  → URL: https://hoanispof.github.io/Human-Predictive-Drive/blog/bridging-neuroscience-psychology/
  → Title: Show HN: Framework mapping brain mechanisms into a connected model (CC0)
...
AUTHOR COMMENT (~180 words):
  ...
  → Giữ: ① WHAT, ② POSITION, ③ OVERVIEW (ngắn hơn), ④ DEEP-DIVES, ⑦ CLOSE
...
```
VERIFY AGAINST BLOG (docs/_posts/2026-06-04-bridging-neuroscience-psychology.md):
  ✓ "11 questions" — blog has 6 single + 5 cluster = 11
  ✓ "6 mechanism sketches" — blog has 3 expanded + 3 brief = 6
  ✓ "five seemingly unrelated experiences traced to one architectural fact"
    — blog cluster section (lines 139-153)
  ✓ "research citations" — every sketch ends with *Source + Research*
  ✓ "conditions for being wrong" — blog Divergences + Limitations sections
  ✓ "200+ source files, CC0" — blog lines 11, 30, 36
  ✓ Core premise: "body evaluates first, PFC observes second" — blog line 32
  ✓ "monitoring process than the main thread" — blog line 32
  ✓ 3 illustrations (thirst, snap, language) — everyday experiences consistent with
    Core-Software.md §1.2 (PFC = observer + orchestrator, CANNOT override strong signals)
    Body-Knowing.md §1.1 (~95% compiled, cost ≈ 0)

VERIFY 4 BLOG LINKS:
  ✓ Descriptions match blog footer (lines 237-241) — consistent language
...
ANTI-PATTERN CHECK:
  ...
  ✓ No self-help framing (W.4) — 3 illustrations describe mechanism, not advice
    "exhausting day" = context for PFC budget depletion, not character judgment
  ✓ No marketing language ("star the repo", "share this")
  ✓ No guru tone
  ✓ No divergences list in short post (belongs in blog)
