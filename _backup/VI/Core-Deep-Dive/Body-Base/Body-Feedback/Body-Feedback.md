...
🟡 HIDDEN QUALITY = "Chưa biết = không có gap" × QUALITY:
  ...
  2 TYPES:
    ① DOMAIN EXPERT: đi qua mọi layer → THẤY technical quality ẩn
       → Bác sĩ THẤY bất thường X-ray 200ms (🟢 Kundel & Nodine 1975)
...
> **END OF Body-Feedback.md v3.1**
>
> **Summary:** Synthesis entry point for Body-Feedback/ folder (v3.1):
>   §1: Folder overview — 17 files, ~27,500L, 4-tier reading guide
...
>       +Pipeline Layer 3: dissonance architecture parallel to reward
...
>   §5: Evaluative/Direct-State + 5 Body-Feedback-Preconditions hypothesis
...
>   §9: Absorbed content map (17 files, +Dissonance-Signal-Architecture unique contributions)
