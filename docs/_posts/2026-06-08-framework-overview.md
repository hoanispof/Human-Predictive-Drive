...
status: Draft v0.1
tags: [neuroscience, psychology, evolutionary-biology, cognitive-science, open-source, framework]
---
...
Full framework with explicit dependencies (200+ source files, CC0): **[GitHub — Human Predictive Drive](https://github.com/hoanispof/Human-Predictive-Drive)**

---

## Stress-test it with AI

Clone the repository. Drop the entire folder into a large-context AI — the framework is 200+ files and benefits from full-context reasoning. The [README](https://github.com/hoanispof/Human-Predictive-Drive#getting-started) contains a starter prompt and reading order.
