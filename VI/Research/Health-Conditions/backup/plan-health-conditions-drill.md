...
§3 — SPM + IDENTITY FRAGMENTATION
  §3.1 — Self-Pattern-Modeling PHẢI CÓ self-chunks để hoạt động
...
```
PHẢI ĐỌC:
  ├── Self-Pattern-Modeling.md v2.3 — SPM + identity (critical)
...
```
PHẢI ĐỌC:
  ├── Self-Pattern-Modeling.md v2.3 — F1/F2, valence, context-dependent
...
THAM KHẢO:
  ...
  ├── Self-Pattern-Modeling.md v2.3 — identity chunks, late diagnosis
...
PHẢI ĐỌC:
  ...
  ├── Self-Pattern-Modeling.md v2.3 — SPM + C-PTSD identity
