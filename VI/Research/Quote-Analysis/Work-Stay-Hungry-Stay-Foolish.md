---
title: "Quote Analysis — Work: Stay Hungry, Stay Foolish"
version: 1.0
created: 2026-05-23
...
# Quote Analysis — Work: Stay Hungry, Stay Foolish
...
> Original: Stewart Brand. Jobs quoting, not coining.
...
⭐ TẠI SAO "STAY FOOLISH" CỰC KHÓ:
  ...
  🟢 PFC budget / ego depletion (refined): Baumeister 2007, Inzlicht 2014
```
...
⭐ JOBS NÓI QUOTE NÀY SAU KHI KỂ VỀ UNG THƯ:
  ...
  🟡 Death as Anchor-Schema disruption: framework synthesis
```
...
⭐ FRAMEWORK GIẢI THÍCH ĐƯỢC GÌ:
  ...
  🟢 ESTABLISHED:
     ...
     Confirmation bias (Nickerson 1998)
     Einstellung effect / expert blindness (Luchins 1942)
     Self-expansion theory (Aron & Aron 1996, 2000)
     Terror Management Theory (Greenberg et al. 1986)
     Post-traumatic growth (Tedeschi & Calhoun 2004)
     Cognitive inhibition (Miyake et al. 2000)
     Hedonic adaptation (Brickman & Campbell 1971)
     Dunning-Kruger effect (Dunning & Kruger 1999)

  FRAMEWORK vs RE-DESCRIPTION:

  Quote: "Stay Hungry, Stay Foolish" (WHAT to do).
...
BIAS RESISTANCE:
  Background-Pattern.md v2.0 — §6 Triple Bias, §6.3 Self-Fulfilling, §5 PFC invisible
  PFC-Operations.md v1.0 — §2 Hold+Suppress, §5 Compiled Quality, §9 PFC Budget
  Self-Pattern-Modeling.md v3.1 — §9 Triple Bias source
...
RELATED RESEARCH:
  Schultz, W. (1997). VTA prediction-delta.
  Aron, A., & Aron, E. N. (1996, 2000). Self-expansion model.
  Nickerson, R. S. (1998). Confirmation bias.
  Luchins, A. S. (1942). Einstellung effect.
  Greenberg, J., Pyszczynski, T., & Solomon, S. (1986). Terror Management Theory.
  Tedeschi, R. G., & Calhoun, L. G. (2004). Post-traumatic growth.
  Miyake, A., et al. (2000). Cognitive inhibition.
  Csikszentmihalyi, M. (1990). Flow theory.
  Deci, E. L., & Ryan, R. M. (2000). Self-Determination Theory.
  Brickman, P., & Campbell, D. T. (1971). Hedonic adaptation.
  Dunning, D., & Kruger, J. (1999). Dunning-Kruger effect.
...
*v1.0 — 2026-05-23*
*Framework v7.8 analysis. Stewart Brand quote, popularized by Steve Jobs (Stanford 2005).*
