...
> 2. **Fatigue** — PFC + network integration tốn processing load (serial bottleneck + catecholamine) vì draft pattern "chưa chạy mượt trên hardware"
...
Nếu learning là "chỉ tốn sức" → sao lại pleasant, tại sao con người proactively tìm kiếm novelty?
...
| **Fatigue** | PFC + network integration cost → processing load (serial bottleneck + catecholamine) | "Effort budget" — còn bao nhiêu capacity? | Signal stop learning before damage, prioritize rest |
...
- Hôm 1: hiểu X, pleasant, mệt, lăn tăn
- Đêm 1: ngủ
...
- 3 concurrent signals ✓ (pleasant + mệt + dissonance nhẹ)
...
**Critical**: 3 signals **đồng thời**, không contradict. Body không gom thành net. Subjective experience: "pleasant vì hiểu *đồng thời* mệt + lăn tăn". Nhiều người describe "pleasant-nặng" (pleasant nhưng mệt), "pleasant-chưa-xong" (pleasant nhưng cần follow up).
...
- Why "sáng hôm sau pleasant hơn + thoải mái hơn + thấy liên kết mới" — three distinct improvements — happen together
...
- **Intrinsic load** = substrate cho draft complexity in stage 1 (more elements to hold → more synapses to form → more processing load)
...
- Stage 2 schema check: slower + less accurate (PFC catecholamine compromise)
...
- `../10-Right-Wrong-Vague.md` (future Phase C) — "vague" may be early cycle stage phenomenon
