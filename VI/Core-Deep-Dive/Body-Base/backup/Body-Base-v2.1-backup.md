...
updated: 2026-05-15 (v2.1 — §5.4 Modulatory vs Processing neurons, Braak validation, Health Conditions Drill)
...
### §5.4 — Modulatory vs Processing neurons: Parkinson validation (v2.1)
...
🟡 2 NHÓM NEURONS × FRAMEWORK LAYERS (Parkinson-Analysis.md §2):
  ...
  MAP VÀO L0-L1-L3:
    ...
    L3 (PFC drives):         modulatory = operators (dopamine, NE, serotonin)
  ...
  BRAAK STAGING VALIDATES ARCHITECTURE (Parkinson-Analysis.md §4.2):
    ...
    → = L0 → L1 → L3 → PFC = CÙNG HƯỚNG ĐI LÊN
  ...
  🟡 Modulatory/Processing × L0-L1-L3 mapping = framework synthesis
```
...
🟡 MEDIUM CONFIDENCE (Framework Synthesis):
  ...
  ⚠ Modulatory vs Processing × L0-L1-L3 mapping (v2.1 — Parkinson drill validates)
  ⚠ Braak staging confirms bottom-up architecture (v2.1)
...
HEALTH CONDITIONS DRILL (v2.1):
  Parkinson-Analysis.md v1.1 — §2 modulatory vs processing, §4.2 Braak staging (→ §5.4)
