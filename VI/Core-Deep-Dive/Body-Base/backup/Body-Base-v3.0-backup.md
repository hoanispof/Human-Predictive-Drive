...
previous: v2.1 → backup/Body-Base-v2.1-backup.md
...
scope: |
  ...
  3-Layer Evolution + 4-Tier Calibration + Circuit Breaker +
...
dependencies:
  ...
  - Body-Coupling.md v1.1 — coupling mechanism, extension/entanglement
  ...
  - Drill-Inter-Body-Mechanism/Inter-Body-Mechanism.md v1.0 — 8 drill principles
  - Body-Feedback/Body-Feedback-Label.md v1.1 — vocabulary reference
...
FILE NÀY TRONG FLOW:
  ...
  │    Body-Coupling.md v1.1           — coupling sâu với entity  │
...
⭐ BODY RESPONDS TO f(PATTERN FIRE), NOT f(INPUT CAUSE):
  ...
  ⭐ UNIFIED PRINCIPLE:
    ...
    → Body đúng ~90%+ (patterns calibrated qua 4 tiers — §7 below)
...
BODY-BASE/ FOLDER OVERVIEW (~60+ files):
  ...
  ├── Valence-Propagation.md v2.0    — Per-entity valence, Entity-Compiled, 2-luồng
  ├── Body-Coupling.md v1.1          — Coupling mechanism (1,534L)
  │
  ...
  │   ├── Body-Feedback-Label.md v1.1 — Vocabulary reference (3-tier)
  ...
  │   ├── Agent-Mechanism/           — SPM, Pattern-Resonance, Agent-Mechanism
...
WITHIN BODY-BASE/ FOLDER:
  ...
  Body-Coupling.md v1.1     — coupling mechanism, extension/entanglement, 2D model
  ...
  Body-Feedback-Label.md v1.1 — vocabulary reference, 3-tier labels
...
>
> Core principles (v3.0 — from Inter-Body Drill + Phase 1-3):
...
>   §7: 4-tier calibration (evolution + development + culture + AI)
...
>
> Phiên bản: v3.0, 2026-05-16.
> Source: Inter-Body Drill (8 principles). Phase 4 ALL REWRITE.
>
> Changelog:
