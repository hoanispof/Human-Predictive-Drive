...
version: 1.3
created: 2026-04-20
updated: 2026-05-15 (v1.3 — §2.3 context-free chunk variant, §3.2 irresolvable miss, Health Conditions Drill cross-refs)
...
⭐ PATTERN-DRIVEN — CHUNKS FIRE TRƯỚC, BODY RESPOND THEO:
  ...
  5 CƠ CHẾ TRIGGER (chunks fire nội bộ):
    ...
    ⓕ CONTEXT-FREE CHUNK FIRE — trauma chunk fires without context (v1.3):
...
⭐ CHUNK-MISS — PATTERN ĐÃ COMPILED NHƯNG KHÔNG ĐƯỢC FIRE:
  ...
  3 VARIANTS:
    ...
    ⓓ MISS IRRESOLVABLE — hardware prevents resolution (v1.3):
...
🟡 FRAMEWORK SYNTHESIS (novel integration):
  ...
  🟡 3+1 Chunk-Miss variants (rõ / mờ / vô thức / irresolvable):
     ...
     v1.3: ⓓ irresolvable = hardware prevents resolution (Parkinson drill).

  🟡 Context-free chunk as Pattern-Driven variant (v1.3):
...
> **v1.3 additions**: §2.3 ⓕ context-free chunk fire (PTSD flashback),
>   §3.2 ⓓ irresolvable miss (Parkinson chronic prediction-delta),
>   Health Conditions Drill cross-refs.
>
> **Phiên bản:** v1.3, 2026-05-15.
