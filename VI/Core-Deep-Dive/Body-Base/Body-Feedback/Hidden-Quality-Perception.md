...
research:
  ...
  Domain-Evidence:
    ...
    - Reingold et al. 2001 — expert chess players visual span (Psychological Science) — eye-tracking expertise
...
⭐⭐ 3 TẦNG MÀ COMPILATION DEPTH TẠO RA KHÁC BIỆT:
  ...
  │    → 🟢 Kundel & Nodine 1975: bác sĩ detect bất thường     │
...
⭐ COPIER BỊ MÙ Ở CẢ 2 TẦNG PROCESSING:
  ...
  EXPERT perceiving quality:
    ...
    → VD: Bác sĩ nhìn X-ray → body "bất thường" → 200ms (Kundel & Nodine 1975)
...
⭐⭐ BẰNG CHỨNG TỪ 7 DOMAINS — CÙNG PATTERN:
  ...
  ⑤ Y KHOA HÌNH ẢNH — Hidden diagnostic quality:
    ...
    🟢 Kundel & Nodine 1975 (Radiology):
      ...
      trong 200ms flash (70% true positive, 10 radiologists).
...
CROSS-REFERENCES:
  ...
  EMPIRICAL RESEARCH (24+ citations):
    ...
    Domain: Birkmeyer 2013, Pantev 1998, Kundel & Nodine 1975, Reingold 2001 (chess),
